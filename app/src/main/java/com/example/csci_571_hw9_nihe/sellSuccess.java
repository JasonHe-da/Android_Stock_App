...
public class sellSuccess  extends AppCompatDialogFragment {
    private int shares;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.sell_success, null);
        view.setClipToOutline(true);
        builder.setView(view);
        TextView ticker = (TextView)view.findViewById(R.id.ticker_sold);
        TextView shares = (TextView)view.findViewById(R.id.ticker_shares_sold);
